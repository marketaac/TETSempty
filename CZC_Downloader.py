...
from CZC_Pages import *
from sqlalchemy import *


class CZC_Downloader:
    '''
    ...
    def __init__(self,allowLog=True):
        '''
        creates CZC_Downloader object with self.links, that store links to be downloaded
        and self.category, self.product and self.price to store individual web-like objects
        '''
        ...
        if self.allowLog:
            print('Succesfully initialized CZC Downloader')
